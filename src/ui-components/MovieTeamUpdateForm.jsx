...
import { getMovieTeam } from "../graphql/queries";
import { updateMovieTeam } from "../graphql/mutations";
function ArrayField({
  items = [],
  onChange,
  label,
...
export default function MovieTeamUpdateForm(props) {
  ...
  React.useEffect(resetStateValues, [movieTeamRecord]);
