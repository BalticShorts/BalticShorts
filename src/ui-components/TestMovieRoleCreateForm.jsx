...
import { listTestMovies, listTestRoles } from "../graphql/queries";
import { createTestMovieRole } from "../graphql/mutations";
function ArrayField({
  items = [],
  onChange,
  label,
...
export default function TestMovieRoleCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setTestMovieRolesId(initialValues.testMovieRolesId);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const modelFieldsToSave = {
            ...
            testMovieRolesId: modelFields.testMovieRolesId,
          };
          await API.graphql({
            query: createTestMovieRole.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFieldsToSave,
              },
      ...
      {...getOverrideProps(overrides, "TestMovieRoleCreateForm")}
      {...rest}
    >
      <ArrayField
        lengthLimit={1}
