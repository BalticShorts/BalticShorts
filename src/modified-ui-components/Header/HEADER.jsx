...
export const Navbar = ({signOut}) => {
  ...
  return (
    <div className="w-full relative bg-amber-50 flex flex-row justify-center items-center">
      <div className="w-full h-full left-0 top-0 absolute bg-amber-50 border-b border-black bg-inherit" />
      ...
      <div className="h-[19px] m-auto pt-1 relative text-black text-lg font-normal font-['SchoolBook'] tracking-tight"><a href="/catalogue">Katalogs</a></div>
        ...
        <div className="h-[30px] relative m-auto pt-1 flex flex-col" >
          ...
          {/* <div className="w-20 h-[30px] right-0 top-0 absolute bg-amber-50 rounded-[20px] border border-black" />
